...
public class PerfumeService
{
	...
	//Perfume delete 
	public PerfumeDTO deletePerfume(int productId)
	{
		PerfumeDTO perfume = this.getPerfumeById(productId);
		perfumeRepo.deleteById(productId);
		return perfume;
	}
	...
	public PerfumeDTO getPerfumeById(int productId)
	{
		Optional<Perfume> optionalData = perfumeRepo.findById(productId);
